    ...
    routes: [
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: '/dishes',
                    component: () => import(/* webpackChunkName: "dashboard" */ '../components/page/dishes/List.vue'),
                    meta: { title: '菜单管理' }
                },
                {
                    path: '/category',
                    component: () => import(/* webpackChunkName: "dashboard" */ '../components/page/category/List.vue'),
                    meta: { title: '类目管理' }
                },
                {
                    path: '/order',
